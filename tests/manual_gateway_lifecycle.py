...
program=pathlib.Path(args.program).resolve();parent=pathlib.Path(args.data_parent).resolve()
# Keep the virtualenv entrypoint; resolving its symlink selects the system environment.
